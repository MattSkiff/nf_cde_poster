...
Normalising flows are trained by maximising the log-likelihood via SGD, or minimising KL-divergence when variational inference is used. Three properties are important for NFs [@kobyzev2020normalizing]:
